...
const PAGES = [
  ['docs/guide.html', 'release/Acustika-guide-fr.pdf'],
  ['docs/en/guide.html', 'release/Acustika-guide-en.pdf']
]
...
const STYLE_PDF = `
  ...
  .hero { padding-top: 0; }
  .grad-text { color: #6D4AE0 !important; -webkit-text-fill-color: #6D4AE0 !important; }
  .piege { border-left: 3px solid #6D4AE0; color: #333; }
`
