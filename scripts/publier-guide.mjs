...
fabriquer(
  ...
  'docs/guide.html',
  'fr',
  'Acustika — par où commencer',
  "Le guide de prise en main d'Acustika : bibliothèque, salle, enceintes, matériaux, conseil. Dans cet ordre, et pourquoi."
)
fabriquer(
  guide,
  'docs/en/index.html',
  'docs/en/guide.html',
  'en',
  'Acustika — where to start',
  'Getting started with Acustika: library, room, loudspeakers, materials, advice. In that order, and why.'
)
